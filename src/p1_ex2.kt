...
Student(firstname:
        ...
        String,ageParams:
        Int,enrollmentno:
        String,branchParams: String,classParams:String,labBatchParams:String) : Person(firstname,
    lastname, ageParams) {
    ...
    constructor(firstname: String, lastname: String) :this(firstname,lastname,18,"not
            assigned","not assigned","not assigned","not assigned") {
}
override fun toString(): String {
    return "name:$firstName $lastName age:$age Enrollmentno:$enrollmentNo
    branch:$branch class$classname batch:$labBatch"
}
}
fun main() {
    val students = listOf(
